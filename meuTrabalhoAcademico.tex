...
\include{./01-elementos-pre-textuais/resumo}

%   Insere os elementos textuais
\textual
 \include{./02-elementos-textuais/1_introducao}			% Introdução
 \include{./02-elementos-textuais/2_revisaoLiteratura}	% Descrição do Problema
 \include{./02-elementos-textuais/3_metodologia}			    % Simulação Computacional
 %\include{./02-elementos-textuais/resultadosEsperados}			    % Resultados Esperados
 \include{./02-elementos-textuais/4_desenvolvimento}
 
 \include{./02-elementos-textuais/5_resultados}
 
 \include{./02-elementos-textuais/6_conclusao}
